// Advanced APIs Demo for JetCrab

console.log("🚀 Starting JetCrab Advanced APIs Demo...\n");
...
// --- Events API ---
console.log("\n--- Events API ---");
const EventEmitter = require('events').EventEmitter || globalThis.EventEmitter;
...
// --- Stream API ---
console.log("\n--- Stream API ---");
const stream = require('stream') || globalThis.stream;
...
// --- Util API ---
console.log("\n--- Util API ---");
const util = require('util') || globalThis.util;
...
// --- URL API ---
console.log("\n--- URL API ---");
const url = require('url') || globalThis.url;
