...
fn main() {
    ...
    let result1 = engine.evaluate("let result = 0; try { result = 10; } catch (e) { result = 20; } result");
    ...
    let result3 = engine.evaluate("let result = 0; try { throw 'error'; } catch (e) { result = 50; } result");
