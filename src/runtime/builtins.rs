...
impl Builtins {
    ...
    fn register_math_functions(&mut self) {
        self.functions.insert("Math.pow".to_string(), Self::math_pow);
        self.functions.insert("Math.abs".to_string(), Self::math_abs);
        self.functions.insert("Math.sqrt".to_string(), Self::math_sqrt);
        self.functions.insert("Math.floor".to_string(), Self::math_floor);
        self.functions.insert("Math.ceil".to_string(), Self::math_ceil);
        self.functions.insert("Math.round".to_string(), Self::math_round);
        self.functions.insert("Math.max".to_string(), Self::math_max);
        self.functions.insert("Math.min".to_string(), Self::math_min);
    }
    
    fn register_string_functions(&mut self) {
        self.functions.insert("String.prototype.toUpperCase".to_string(), Self::string_to_upper);
        self.functions.insert("String.prototype.toLowerCase".to_string(), Self::string_to_lower);
        self.functions.insert("String.prototype.trim".to_string(), Self::string_trim);
        self.functions.insert("String.prototype.length".to_string(), Self::string_length);
        
        // Also register with simpler names for direct access
        self.functions.insert("toUpperCase".to_string(), Self::string_to_upper);
        self.functions.insert("toLowerCase".to_string(), Self::string_to_lower);
        self.functions.insert("trim".to_string(), Self::string_trim);
    }
    
    fn register_array_functions(&mut self) {
        self.functions.insert("Array.prototype.push".to_string(), Self::array_push);
        self.functions.insert("Array.prototype.pop".to_string(), Self::array_pop);
        self.functions.insert("Array.prototype.length".to_string(), Self::array_length);
    }
