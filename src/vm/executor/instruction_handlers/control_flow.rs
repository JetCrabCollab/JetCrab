...
//!
//! ControlFlowHandler::jump::<StackManager, VariableManagerImpl>(&mut stack, &mut registers, CodeAddress::from(100)).unwrap();
//! ```
...
impl ControlFlowHandler {
    ...
    /// let mut stack = StackManager::new();
    /// let mut registers = Registers::new();
    /// let new_ip = ControlFlowHandler::jump::<StackManager, VariableManagerImpl>(&mut stack, &mut registers, CodeAddress::from(100)).unwrap();
