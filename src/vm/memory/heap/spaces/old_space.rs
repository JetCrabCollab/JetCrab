...
use crate::vm::memory::heap::allocation::{FreeListAllocator, MemoryInfo, DefragmentationStats};
use crate::vm::memory::heap::spaces::{GcStats, CompactionStats};
...
mod tests {
    ...
    fn test_old_space_collect() {
        ...
        assert_eq!(old_space.stats.object_count, before_objects - stats.objects_collected);
    }
