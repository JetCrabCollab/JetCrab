...
impl MinorGc {
    ...
    pub fn collect(
        ...
        let _space_types: Vec<SpaceType> = spaces.keys().cloned().collect();
    ...
    fn perform_copying_collection_safe(
        ...
        let _objects_to_collect: Vec<HeapHandleId> = Vec::new();
    ...
    fn simulate_new_space_reset(&self, _new_space: &mut Box<dyn MemorySpace>) {
        // In a real implementation, this would:
