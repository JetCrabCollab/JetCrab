...
pub use write_barrier::{BarrierType, WriteBarrier, WriteBarrierStats};
...
impl GarbageCollector {
    ...
    pub fn record_reference_write(
        &mut self,
        source_object: HeapHandleId,
        target_object: HeapHandleId,
    ) {
        self.write_barrier
            .record_reference_write(source_object, target_object);
    }
